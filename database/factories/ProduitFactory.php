...
class ProduitFactory extends Factory
{
    ...
    public function definition(): array
    {
        return [
            'id' => Str::uuid(),
            'user_id' => User::inRandomOrder()->first()->id, // Crée un user associé
            // 'category_id' => CategoryProduit::factory(), // Crée une CategoryProduit associée
            'category_id' => CategoryProduit::inRandomOrder()->first()?->id,
            ...
            // 'marg    e_min' => $this->faker->randomFloat(2, 100, 5000), // Marge entre 100 et 5000 FCFA
